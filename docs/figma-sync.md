...
| Checkbox                   | `1278:2207`                                                                                                  | `packages/ui/src/primitives/Checkbox.tsx`, `packages/ui/src/icons/generated/CheckIcon.tsx`, `packages/ui/src/assets/input-checkbox-indeterminate.svg`                     | `Primitives/Checkbox` (`VariantCollection`)                                                                 | Partially Synced — exact sm/md/lg targets, indicators, shared CheckIcon checked glyph, exact indeterminate glyph, and Default/Hover/Focused/Checked/Disabled/Error/Indeterminate roles are token-bound; dark aliases are provisional because Figma publishes no dark Checkbox mode; React is the current reference implementation | 2026-07-21   |
