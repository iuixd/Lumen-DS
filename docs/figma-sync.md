...
| Input                      | `1262:1181`                                                                                                  | `packages/ui/src/primitives/Input.tsx`                                                                                                                                    | `Primitives/Input` (`VariantCollection`)                                                                    | Partially Synced — exact Figma light-mode component tokens, sm/md/lg geometry, Default/Hover/Focused/Error borders, and search anatomy are bound; dark aliases are provisional because Figma publishes no dark Input mode; React is the current reference implementation                         | 2026-07-21   |
