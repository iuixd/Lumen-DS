...
| Checkbox                   | `1278:2207`                                                                                                  | `packages/ui/src/primitives/Checkbox.tsx`, `packages/ui/src/assets/input-checkbox-*.svg`                                                                                  | `Primitives/Checkbox` (`VariantCollection`)                                                                 | Partially Synced — exact sm/md/lg targets, indicators, check/indeterminate glyphs, and Default/Hover/Focused/Checked/Disabled/Error/Indeterminate roles are token-bound; dark aliases are provisional because Figma publishes no dark Checkbox mode; React is the current reference implementation | 2026-07-21   |
